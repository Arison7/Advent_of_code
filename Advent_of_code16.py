...
class parsing:
    ...
    def size_mode(self):
        ...
        self.children.append(new_sub_packet)
    ...
    def __call__(self):
        if self.id_ == 4:
            return int(self.literial_value,2)
        to_return : list = []
        for child in self.children:
            to_return.append(child())
        return self.functions[self.id_](to_return)
...
def main():
    data : str = get_data(r'D:\Coding\Python\handy\cases.txt')
